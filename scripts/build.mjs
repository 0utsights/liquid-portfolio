...
const projectRows = projects.map(p=>`<article class="project-row"><div class="project-summary"><h3><a href="/work/${p.slug}/">${displayTitle(p)}</a></h3><p>${p.summary}</p></div><div class="project-support">${tags(p.stack)}<div class="project-evidence">${p.links.map(([label,href])=>ext(label,href)).join('')}</div></div></article>`).join('');
...
const home = `<section class="hero" aria-labelledby="intro-name">
 <div class="hero-copy"><p class="eyebrow">Software engineering · Internship applications</p><h1 id="intro-name">John Surles</h1><p class="hero-description">Virginia Tech · B.S. Computer Science<br><span>Attending since August 2026 · Graduating May 2028</span><span>Blacksburg, Virginia</span></p></div>
...
<body><a class="skip-link" href="#main">Skip to content</a><header class="site-header" data-identity="visible"><nav class="main-nav" aria-label="Main navigation">${nav}</nav><div class="header-identity"><a class="wordmark" href="/" aria-label="John Surles, home">John Surles</a><div class="header-actions" id="contact"><a class="text-link" href="mailto:surlesjohn@outlook.com">Email</a><a class="text-link" href="/John-Surles-Resume.pdf" aria-label="Resume (PDF)">Resume</a></div></div></header><main id="main" tabindex="-1">${route.body}</main><footer class="site-footer"><div class="footer-bottom"><span>© 2026 John Surles</span><div class="footer-links">${ext('GitHub','https://github.com/0utsights')}${ext('LinkedIn','https://www.linkedin.com/in/john-surles-650a16389/')}<a class="text-link" href="mailto:surlesjohn@outlook.com">Email</a><a class="text-link" href="/John-Surles-Resume.pdf">Resume PDF</a></div></div></footer></body></html>`;
}
